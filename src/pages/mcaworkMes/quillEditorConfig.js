...
/*富文本编辑图片上传配置*/
const uploadConfig = {
  action: actionUrl, // 必填参数 图片上传地址
  methods: 'POST', // 必填参数 图片上传方式
  token: LocalGetToken(), // 可选参数 如果需要token验证，假设你的token有存放在sessionStorage
...
export default function(quillEditorRef) {
  const handler = {
    image: (value) => {
  ...
  return {
    placeholder: '',
    theme: 'snow', // 主题  or 'bubble'
    modules: {
      toolbar: {
        container: toolOptions, // 工具栏选项
        handlers: handler, // 事件重写
      },
    },
  }
}
