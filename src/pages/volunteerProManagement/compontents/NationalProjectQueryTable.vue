<template>
  <div>
    <!-- 全国项目查询列表 -->
    <IATable
      serviceName="managementDepartmentSelProjectNationalFortis"
      :searchParameter="searchFunc"
      ref="table"
      size="middle"
      :rowKey="(record) => record.id"
      :columns="NationalProjectQueryColumns"
    >
...
import { NationalProjectQueryColumns } from '../columns'
  ...
  setup(props) {
    ...
    const searchFunc = () => {
      return {
        ...
        albx0015: props.activeKey == 1 ? '0,1,2,3,4,5' : props.activeKey == 2 ? '6,7,12' : '8,9,11,13',
    ...
    const heanViewTeamInfo = (record) => {
      ...
      let obj = {
        type: 'view', //查看
        isRepair: record.albx0015 == 12 ? true : false, //是否是补录不通过项目
