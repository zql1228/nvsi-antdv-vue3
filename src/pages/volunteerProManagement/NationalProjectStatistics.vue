<template>
  ...
  <PageFormTableWrapper>
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="24">
            <a-form-item label="项目状态" name="albx0072">
              <a-select v-model:value="queryParam.albx0072" :options="optionsList.albx0072List" :disabled="selectType == 6" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="招募范围" name="albx0024">
              <a-select v-model:value="queryParam.albx0024" :options="optionsList.albx0024List" :disabled="selectType == 5"> </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24" v-show="advanced">
            <a-form-item label="服务类别" name="albx0009">
              <a-select v-model:value="queryParam.albx0009" :disabled="selectType == 7">
          ...
          <a-col :md="6" :sm="24" v-show="advanced">
            <a-form-item label="服务对象" name="albx0014">
              <a-select v-model:value="queryParam.albx0014" :disabled="selectType == 3">
    ...
    <template #table>
      <NationalProjectStatisticsEachar
        :queryParam="queryParam"
        :advanced="advanced"
        ref="NationalProjectStatisticsEachar"
        @child="child"
      ></NationalProjectStatisticsEachar>
    </template>
  </PageFormTableWrapper>
...
import NationalProjectStatisticsEachar from './NationalProjectStatisticsEachar.vue'
...
export default defineComponent({
  components: { DownOutlined, UpOutlined, NationalProjectStatisticsEachar },
  setup() {
    ...
    const NationalProjectStatisticsEachar = ref()
    ...
    const getOptions = async () => {
      ...
      optionsList.albx0009List.unshift({ codevalue: '不限', codeid: '' })
      //服务对象
      ...
      optionsList.albx0014List.unshift({ codevalue: '不限', codeid: '' })
    }
    ...
    const refresh = () => {
      ...
      searchFormRef.value
        .validate()
        .then(() => {
          NationalProjectStatisticsEachar.value.getData()
        })
        .catch((error) => {
          console.log(error)
        })
    ...
    const showExpand = () => {
      ...
      nextTick(() => {
        NationalProjectStatisticsEachar.value.showExpand()
      })
    }
