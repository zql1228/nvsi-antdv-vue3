<template>
  ...
  <PageFormTableWrapper>
          ...
          <a-row :gutter="24">
            ...
            <a-col :md="6" :sm="24" v-show="advanced">
              <a-form-item label="服务类别" name="albe0017">
                <a-select v-model:value="queryParam.albe0017" :options="optionsList.albe0017List" :disabled="selectType == 2"> </a-select>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24" v-show="advanced">
    ...
    <template #table>
      <NationalTeamStatisticsChart ref="teamEachar" :queryParam="queryParam" :advanced="advanced" @child="child"></NationalTeamStatisticsChart>
    </template>
  </PageFormTableWrapper>
</template>
...
import NationalTeamStatisticsChart from './table/NationalTeamStatisticsChart.vue'
