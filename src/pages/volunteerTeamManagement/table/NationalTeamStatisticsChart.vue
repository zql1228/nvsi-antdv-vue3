  ...
  <div>
    <a-row :gutter="[0, 19]">
      <a-col :span="24" style="postition:relative;">
        ...
        <a-select v-model:value="queryParam.type" :options="options" @select="search"></a-select>
          ...
          xAxis: {
            ...
            axisLabel: {
              ...
              formatter: function(value) {
                if (queryParam.type == 1 && value.length > 7 && value.length < 14) {
                  value = value.substring(0, 7) + '\n' + value.substring(7)
                } else if (queryParam.type == 1 && value.length > 14) {
