              ...
              <div class="clearfix">
                ...
                <a-upload :file-list="fileList2" list-type="picture-card" :beforeUpload="beforeUpload" :customRequest="handleFileUpload2">
                  <div v-if="fileList2.length < 1 && !imageUrl">
                    <plus-outlined />
                    <div style="margin-top: 8px">上传新闻封面</div>
                  </div>
                </a-upload>
              </div>
            </a-form-item>
...
export default defineComponent({
  ...
  setup(props, text) {
    ...
    const rules = reactive({
      ...
      newsfrom: [{ required: true, message: '请输入新闻来源', trigger: 'blur' }],
      isvideonews: [{ required: true, message: '请选择是否视频新闻', trigger: 'blur' }],
